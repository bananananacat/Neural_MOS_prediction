...
В данном репозитории вы можете найти код моделей, предсказывающих MOS оценку аудио, а также различные эксперименты с моими архитектурами. Через какое-то время выйдет статья на Хабре, а веса моделей появятся на HuggingFace
